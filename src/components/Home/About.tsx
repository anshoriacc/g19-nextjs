  ...
  return (
    <section className="bg-white dark:bg-gray-900 px-[5%] sm:px-[10%] py-6">
      <div className="max-w-[1200px] mx-auto flex flex-col">
        ...
        <div className="h-full grid grid-cols-1 md:grid-cols-[400px_1fr] gap-4 flex-1 justify-center md:items-center overflow-hidden">
          <div className="hidden md:inline w-full max-w-[400px] mx-auto h-[calc(50%-0.5rem)] md:h-full max-h-60 bg-gray-200 rounded-xl overflow-hidden">
            <Map />
          </div>
